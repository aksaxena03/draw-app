    ...
    <main className="min-h-screen flex flex-col bg-[#2f2f2f] text-white">
        ...
        <div className="absolute top-4 right-4 flex gap-3 z-10">
            {[
              ...
              >
                <Link
                  href={btn.href}
                  className="px-4 py-1.5 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full text-md font-semibold shadow-lg hover:shadow-purple-500/50 hover:scale-105 transition"
                >
                  {btn.text}
                </Link>
              </motion.div>
      ...
      <section className="flex flex-col items-center justify-center flex-1 text-center px-6 relative overflow-hidden">
        ...
        >
          <Link
            href="/dashboard"
            className="px-8 py-3 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full text-lg font-semibold shadow-lg hover:shadow-purple-500/50 hover:scale-105 transition"
          >
            Start Drawing
          </Link>
        </motion.div>
